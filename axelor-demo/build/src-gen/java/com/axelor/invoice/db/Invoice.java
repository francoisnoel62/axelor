...
@Entity
@Cacheable
@Table(name = "INVOICE_INVOICE", indexes = { @Index(columnList = "customer"), @Index(columnList = "accounting_account") })
public class Invoice extends AuditableModel {
	...
	@ManyToOne(fetch = FetchType.LAZY, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
	private Accounting accountingAccount;
	...
	public Accounting getAccountingAccount() {
		return accountingAccount;
	}

	public void setAccountingAccount(Accounting accountingAccount) {
